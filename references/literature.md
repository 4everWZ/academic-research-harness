...
4. if persistence is requested, record candidate changes, expected value and cost, evidence gaps, risks, and required experiments in `idea_log.md` using the [bundled template](../assets/templates/idea_log.md);
